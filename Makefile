...
broker: 
	@ansible-playbook -i inventories/vagrant/inventory playbooks/brokers.yml 
 
common: 
	@ansible-playbook -i inventories/vagrant/inventory playbooks/common.yml 
	
logging:
	@ansible-playbook -i inventories/vagrant/inventory playbooks/logging.yml 

ucd: 
	@ansible-playbook -i inventories/vagrant/inventory playbooks/ucd.yml 
